...
public class EventListManager {
     ...
     *
     * @return instance : The event.EventListManager instance.
     */
     ...
     *
     * @param event (entity.Event) : the event to be inserted in the list.
     */
     ...
     *
     * @return firstEvent (entity.Event) : the first event of the list.
     */
    public Event poll() {
